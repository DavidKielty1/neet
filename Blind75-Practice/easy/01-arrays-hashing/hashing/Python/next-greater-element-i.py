...
class Solution:
    def nextGreaterElement(self, nums1: List[int], nums2: List[int]) -> List[int]:
        """
        Approach: Use stack to find next greater elements, then hash map

        Strategy:
        1. Use monotonic stack to find next greater for all nums2 elements
