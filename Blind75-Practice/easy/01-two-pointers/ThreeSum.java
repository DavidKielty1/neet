...
Output: [[-1,-1,2],[-1,0,1]]
Hint: Sort, fix i, then two-sum toward target -nums[i]; skip duplicate i/left/right.

Example 2:
Input: nums = [0,1,1]
Output: []
Hint: No triple sums to 0; same pointer discipline applies when nothing balances.
