...
When creating new practice files anywhere under `hard/`, follow the same structure as the Java template in `BinarySearchSimilar1.java`.
...
- Hard folders are currently Java-first scaffolds.
- Use the same hidden-spoiler layout consistently across all hard sections.
